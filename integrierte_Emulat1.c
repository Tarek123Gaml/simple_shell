...
/**
 * histo_list - displays the history list
...
/**
 * Not_pseud - sets alias to string
...
/**
 * Yes_pseud - sets alias to string
 * @info: parameter struct
 * @str: the string alias
 *
 * Return: Always 0 on success, 1 on error
...
/**
 * imprime_pseud - prints an alias string
 * @node: the alias node
 *
 * Return: Always 0 on success, 1 on error
 */
...
/**
 * pseudy - mimics the alias builtin (man alias)
